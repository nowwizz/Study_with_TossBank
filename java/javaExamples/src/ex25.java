...
public class ex25 {
    public static void main(String[] args) {
        ...
        System.out.println(uBun1); //0x3b07d329
        System.out.println(uBun2); //0x3b07d329
        uBun1.bunNo = 40;
