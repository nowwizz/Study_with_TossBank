...
//         : Getter/Setter 함수통해서 접근 가능하도록 허용.
//         : 은행잔고를 창구를 통해서만 접근가능하도록

//class 앞에 아무것도 없다 = default
class Hong {
    String name = "홍길동"; //default : 같은 폴더 + 자기 클래스 접근가능
    public int age = 20; //public : 모든 폴더 + 상속관계 + 같은 폴더 + 자기 클래스
    protected int korScore = 80; //상속관계 + 같은 폴더 + 자기 클래스
    ...
    public void setEngScore(int engScore) { //우클릭 -> 생성 -> setter : 정해진 형식으로 생성
...
public class ex22 {
    public static void main(String[] args) {
        ...
        //System.out.println(hong.engScore); -> error
