...
public class MainController { //HttpServlet 클래스를 상속받아서, 서블릿으로 등록됨
    ...
    //public String index()
    //public String root()
    public String main() { //Sevlet Method
    ...
    @RequestMapping("/model1") //모든 타입(GET/POST/PUT/DELETE) 요청을 받을 수 있음
    ...
    public String model2(HttpServletRequest request) {
        String param_name = request.getParameter("name"); //input 태그 name의 속성값
