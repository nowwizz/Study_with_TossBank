...
// 리액트 엘리먼트는 **불변(immutable)**이며 한 번 생성되면 그 내용을
// 변경할 수 없습니다. 대신 새로운 엘리먼트를 생성하여 화면의 변화를 반영합니다.
...
//이벤트 처리
//소괄호 없이 return하는 경우: return 뒤에 바로 JSX나 값이 올 때
//소괄호로 return하는 경우: 함수 컴퍼넌트로 return할 때
