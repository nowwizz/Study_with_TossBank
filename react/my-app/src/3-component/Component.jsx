...
//           부모의 State가 변경되면, 자식 컴포넌트가 재렌더링 됨.
...
class GreetingClass extends React.Component {
  render() {
    ...
    //오버로딩(over loading) : 함수(메서드)의 매개변수의 개수와 타입을 다르게 함으로 확장하는 것
    return <h1>Hello React Component! {this.props.name}</h1>;
  }
}
...
function GreetingFunc(props) {
  return <h1>Hello React Component! {props.name}</h1>;
}
